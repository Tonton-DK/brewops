---
name: verify-change
description: Verify that the project still works. This includes checking the database, running tests, and ensuring the application starts correctly. Use when someone asks to verify a change.
---

Verify a change to BrewOps and report the evidence. Do not claim success without showing command output.
